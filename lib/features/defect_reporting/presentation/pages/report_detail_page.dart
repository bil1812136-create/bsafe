  ...
  void _showUpdateForm() {
    showModalBottomSheet(
      ...
      builder: (ctx) => _WorkerResponseForm(
        report: _report,
        onSubmitted: (updated) => setState(() => _report = updated),
      ),
    );
  }
        ...
        child: Stack(children: [
          Center(
              child: InteractiveViewer(
                  minScale: 0.5, maxScale: 5.0, child: imageWidget)),
          Positioned(
            top: 40,
            right: 16,
            child: SafeArea(
    ...
    if (_report.imageUrl != null && _report.imageUrl!.isNotEmpty) {
      return GestureDetector(
        ...
        child: Container(
            ...
            height: 250,
            decoration: BoxDecoration(color: Colors.grey.shade200),
            child: Image.network(_report.imageUrl!,
                fit: BoxFit.cover,
            ...
            onPressed: () async {
              ...
              if (updated != null && mounted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text('已從雲端刷新'), duration: Duration(seconds: 1)));
              }
            },
          ),
        ],
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      if (!_report.synced) ...[
                        ...
                        Text('未同步',
                            style: TextStyle(
                                color: Colors.orange.shade600, fontSize: 14)),
                      ],
                    ]),
                      ...
                      child: Row(children: [
                        ...
                        Expanded(
                            child: Column(
                              ...
                              Text(AppTheme.getRiskLabel(_report.riskLevel),
                                  style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold,
                                      color: AppTheme.getRiskColor(
                    ...
                    _DetailSection(
                        ...
                        icon: Icons.category,
                        content:
                            ReportModel.getCategoryLabel(_report.category)),
                    _DetailSection(
                        title: '嚴重程度',
                        icon: Icons.warning_amber,
                        content:
                            ReportModel.getSeverityLabel(_report.severity)),
...
class _RiskBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Text(AppTheme.getRiskLabel(riskLevel),
            style: const TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold,
                fontSize: 14)),
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return _buildBubble(context, msg, isCompany);
            },
          ),
        ),
      ]),
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisSize: MainAxisSize.min, children: [
            Icon(isCompany ? Icons.business : Icons.engineering,
                size: 14,
                color: isCompany ? Colors.blue.shade700 : Colors.teal.shade700),
            const SizedBox(width: 4),
            Text(isCompany ? '公司' : '工人',
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 11,
                    color: isCompany
          ...
          Text(msg.text,
              style: TextStyle(
                  fontSize: 13,
                  color:
                      isCompany ? Colors.blue.shade900 : Colors.teal.shade900)),
        ]),
      ),
    );
  }
...
class _WorkerResponseFormState extends ConsumerState<_WorkerResponseForm> {
  ...
  Future<void> _submit() async {
    ...
    if (text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('請輸入回覆內容'), backgroundColor: Colors.orange));
      return;
    }
    ...
    if (success) {
      ...
      final updated = widget.report.copyWith(
          ...
          updatedAt: DateTime.now()) as ReportModel;
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('發送失敗，請稍後再試'), backgroundColor: Colors.red));
    }
  }
