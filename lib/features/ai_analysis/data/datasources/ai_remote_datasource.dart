...
class AiRemoteDataSource {
  ...
  Future<Map<String, dynamic>> _queryGemini(
    ...
    final uri = Uri.parse(
        '${AppConfig.geminiApiBaseUrl}/${AppConfig.geminiModel}:generateContent?key=${AppConfig.geminiApiKey}');
    ...
    if (response.statusCode != 200) {
      if (response.body
        ...
        throw Exception(
            'Gemini API region not supported. Use Vertex AI instead.');
      }
